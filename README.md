...
`[11/11/20]` - Added a [`TFCNNv2_softmax.h`](https://github.com/TFCNN/TFCNNv2/blob/main/TFCNNv2_softmax.h) version for multiple classification on the same network, using a softmax layer with cross-entropy loss.
`[12/11/20]` - Added a [`TFCNNv2_multiclass.h`](https://github.com/TFCNN/TFCNNv2/blob/main/TFCNNv2_multiclass.h) version for multiple classification on the same network.
