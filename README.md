...
<br>`[12/11/20]` - Added [`TFCNNv2_multiclass.h`](https://github.com/TFCNN/TFCNNv2/blob/main/TFCNNv2_multiclass.h) for regular multiple classification on the same network.
<br>`[01/01/21]` - Added optional loss functions in [`TFCNNv1.h`](https://github.com/TFCNN/TFCNNv2/blob/main/TFCNNv2.h) and corrected the code to allow non-destructive use of changing the uint defitionion to smaller storage types.
