...
`[9/11/20]` - Added a [`TFCNNv21.h`](https://github.com/TFCNN/TFCNNv2/blob/main/TFCNNV2.1/TFCNNv21.h) version which has more accurate computations of `SELU, GELU, MISH, SQNL` and `SINC`.<br>
