...
This example is a parrot bot service which makes use of `TFCNNv2.h`, it will randomly generate quotes that score highly against the binary classifier / discriminator.
