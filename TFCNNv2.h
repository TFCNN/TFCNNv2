...
static inline float seluDerivative(const float x)
{
    ...
    const float fx = ((1.758094-(-x)) - selu_table[i]) * 91.007652196;
    return selu_table[i] * (1.f - fx) + selu_table[i+1] * fx;
}
